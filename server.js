...
app.use(cors({
  origin: ['http://localhost:3000', 'http://localhost:3001', 'https://sansieutoc-web-fe.vercel.app', 'https://www.sansieutoc.com', 'https://sansieutoc.com', 'https://zkoo0400gsgowowok84o8cck.qroma.tinkering.vn'],
  credentials: true,
}));
